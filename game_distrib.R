...
# Simulation number for flight energetics
sim_num = 10000
...
# Flight energetics function, derived from Colin Pennycuick's Flight 
# program
flight_energetics = 
  function(
    body_mass,
    ...
    body_mass_flight_velocity_kmhr_coefs = 
      flight_metrics_table[
        ,
        lm(
          flight_velocity_kmhr ~ body_mass
        )$coefficients
      ]
    ...
    flight_metrics_table[
      ...
      pred_flight_velocity_kmhr :=
        (flight_velocity_kmhr_slope * body_mass) + flight_velocity_kmhr_intercept
    ]
    ...
    flight_cost_body_mass_rel =
      flight_metrics_table[
        ,
        lm(
          flight_cost_kgkm ~ body_mass
        )
      ]$coefficients
    
    output = 
      list(
        flight_vel_body_mass_rel = flight_vel_body_mass_rel,
        flight_cost_body_mass_rel = flight_cost_body_mass_rel
      )
...
flight_vel_body_mass_rel = flight_energetics_output$flight_vel_body_mass_rel
flight_cost_body_mass_rel = flight_energetics_output$flight_cost_body_mass_rel
